...
namespace Tribe\Alert_Scoped\Args\TaxQuery;
...
final class Query implements Arrayable, Values
{
     ...
     * @return static
     */
    public static final function fromArray(array $queries) : self
    {
        $class = new static();
    ...
    {
        return \count($query) === 0 || \array_key_exists('terms', $query) || \array_key_exists('taxonomy', $query) || \array_key_exists('include_children', $query) || \array_key_exists('field', $query) || \array_key_exists('operator', $query);
    }
    public final function addClause(Clause $clause, ?string $key = null) : void
    {
        if (null !== $key) {
    ...
    public final function addQuery(Query $query, ?string $key = null) : void
    {
        if (null !== $key) {

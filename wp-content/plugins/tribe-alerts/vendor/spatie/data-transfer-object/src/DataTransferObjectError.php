...
class DataTransferObjectError extends TypeError
{
    ...
    {
        $msg = \count($invalidTypes) > 1 ? "The following invalid types were encountered:\n" . \implode("\n", $invalidTypes) . "\n" : "Invalid type: {$invalidTypes[0]}.";
        throw new self($msg);
    }
    public static function invalidTypeMessage(string $class, string $field, array $expectedTypes, $value) : string
    {

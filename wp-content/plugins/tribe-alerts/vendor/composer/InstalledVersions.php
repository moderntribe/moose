 ...
 */
namespace Tribe\Alert_Scoped\Composer;

use Tribe\Alert_Scoped\Composer\Autoload\ClassLoader;
use Tribe\Alert_Scoped\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('Tribe\\Alert_Scoped\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();

...
use Tribe\Alert_Scoped\DI\Definition\FactoryDefinition;
use Tribe\Alert_Scoped\DI\Definition\Helper\DefinitionHelper;
use Tribe\Alert_Scoped\DI\Definition\InstanceDefinition;
use Tribe\Alert_Scoped\DI\Definition\ObjectDefinition;
use Tribe\Alert_Scoped\DI\Definition\Resolver\DefinitionResolver;
use Tribe\Alert_Scoped\DI\Definition\Resolver\ResolverDispatcher;
use Tribe\Alert_Scoped\DI\Definition\Source\DefinitionArray;
use Tribe\Alert_Scoped\DI\Definition\Source\MutableDefinitionSource;
use Tribe\Alert_Scoped\DI\Definition\Source\ReflectionBasedAutowiring;
use Tribe\Alert_Scoped\DI\Definition\Source\SourceChain;
use Tribe\Alert_Scoped\DI\Definition\ValueDefinition;
use Tribe\Alert_Scoped\DI\Invoker\DefinitionParameterResolver;
use Tribe\Alert_Scoped\DI\Proxy\NativeProxyFactory;
use Tribe\Alert_Scoped\DI\Proxy\ProxyFactory;
use Tribe\Alert_Scoped\DI\Proxy\ProxyFactoryInterface;
use InvalidArgumentException;
use Tribe\Alert_Scoped\Invoker\Invoker;
use Tribe\Alert_Scoped\Invoker\InvokerInterface;
use Tribe\Alert_Scoped\Invoker\ParameterResolver\AssociativeArrayResolver;
use Tribe\Alert_Scoped\Invoker\ParameterResolver\Container\TypeHintContainerResolver;

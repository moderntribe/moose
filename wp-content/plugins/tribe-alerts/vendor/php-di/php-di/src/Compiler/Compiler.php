...
namespace Tribe\Alert_Scoped\DI\Compiler;

use function chmod;
use Tribe\Alert_Scoped\DI\Definition\ArrayDefinition;
use Tribe\Alert_Scoped\DI\Definition\DecoratorDefinition;
...
use Tribe\Alert_Scoped\DI\Definition\Source\DefinitionSource;
use Tribe\Alert_Scoped\DI\Definition\StringDefinition;
use Tribe\Alert_Scoped\DI\Definition\ValueDefinition;
use Tribe\Alert_Scoped\DI\DependencyException;
use Tribe\Alert_Scoped\DI\Proxy\ProxyFactoryInterface;
use function dirname;
use function file_put_contents;
use InvalidArgumentException;
use Tribe\Alert_Scoped\Laravel\SerializableClosure\Support\ReflectionClosure;
use function rename;

...
namespace Tribe\Alert_Scoped\DI\Proxy;

use Tribe\Alert_Scoped\ProxyManager\Configuration;
use Tribe\Alert_Scoped\ProxyManager\Factory\LazyLoadingValueHolderFactory;
use Tribe\Alert_Scoped\ProxyManager\FileLocator\FileLocator;
use Tribe\Alert_Scoped\ProxyManager\GeneratorStrategy\EvaluatingGeneratorStrategy;
use Tribe\Alert_Scoped\ProxyManager\GeneratorStrategy\FileWriterGeneratorStrategy;
/**

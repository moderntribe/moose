...
use Tribe\Alert_Scoped\Monolog\Utils;
use Tribe\Alert_Scoped\PhpConsole\Connector;
use Tribe\Alert_Scoped\PhpConsole\Handler as VendorPhpConsoleHandler;
use Tribe\Alert_Scoped\PhpConsole\Helper;
/**
...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    ...
    {
        if (!\class_exists('Tribe\\Alert_Scoped\\PhpConsole\\Connector')) {

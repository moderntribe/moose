...
use Tribe\Alert_Scoped\Aws\Sdk;
use Tribe\Alert_Scoped\Aws\DynamoDb\DynamoDbClient;
use Tribe\Alert_Scoped\Monolog\Formatter\FormatterInterface;
use Tribe\Alert_Scoped\Aws\DynamoDb\Marshaler;
use Tribe\Alert_Scoped\Monolog\Formatter\ScalarFormatter;

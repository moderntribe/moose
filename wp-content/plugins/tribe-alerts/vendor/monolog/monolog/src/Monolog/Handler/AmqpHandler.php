...
use Tribe\Alert_Scoped\Monolog\Formatter\JsonFormatter;
use Tribe\Alert_Scoped\PhpAmqpLib\Message\AMQPMessage;
use Tribe\Alert_Scoped\PhpAmqpLib\Channel\AMQPChannel;
use AMQPExchange;
/**

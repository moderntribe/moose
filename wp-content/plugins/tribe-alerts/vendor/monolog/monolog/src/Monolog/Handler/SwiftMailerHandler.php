...
use Tribe\Alert_Scoped\Swift_Message;
use Tribe\Alert_Scoped\Swift;
/**
...
class SwiftMailerHandler extends MailHandler
{
     ...
     */
    public function __construct(\Tribe\Alert_Scoped\Swift_Mailer $mailer, $message, $level = Logger::ERROR, bool $bubble = \true)
    {

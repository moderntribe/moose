 ...
 */
namespace Tribe\Alert_Scoped\Monolog\Handler;

use Tribe\Alert_Scoped\Elastic\Elasticsearch\Response\Elasticsearch;
use Throwable;
use RuntimeException;
use Tribe\Alert_Scoped\Monolog\Logger;
use Tribe\Alert_Scoped\Monolog\Formatter\FormatterInterface;
use Tribe\Alert_Scoped\Monolog\Formatter\ElasticsearchFormatter;
use InvalidArgumentException;
use Tribe\Alert_Scoped\Elasticsearch\Common\Exceptions\RuntimeException as ElasticsearchRuntimeException;
use Tribe\Alert_Scoped\Elasticsearch\Client;
use Tribe\Alert_Scoped\Elastic\Elasticsearch\Exception\InvalidArgumentException as ElasticInvalidArgumentException;
use Tribe\Alert_Scoped\Elastic\Elasticsearch\Client as Client8;
/**

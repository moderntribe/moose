...
namespace Tribe\Alert_Scoped\enshrined\svgSanitize\ElementReference;

use Tribe\Alert_Scoped\enshrined\svgSanitize\data\XPath;
use Tribe\Alert_Scoped\enshrined\svgSanitize\Exceptions\NestingException;
use Tribe\Alert_Scoped\enshrined\svgSanitize\Helper;
class Resolver
{
    /**
     * @var XPath

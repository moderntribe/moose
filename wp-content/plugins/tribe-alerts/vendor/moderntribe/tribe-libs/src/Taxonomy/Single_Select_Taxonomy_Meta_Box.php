...
use Tribe\Alert_Scoped\Tribe\Libs\Taxonomy\Walker\Walker_Category_Radio_List;
/**
...
class Single_Select_Taxonomy_Meta_Box
{
    ...
    public function callback($post, $box)
    {
        ...
        ?>"
					...
					<?php 
        \wp_terms_checklist($post->ID, ['taxonomy' => $this->taxonomy, 'walker' => new Walker_Category_Radio_List()]);
        ?>
				</ul>
			</div>
		</div>

...
namespace Tribe\Alert_Scoped\Tribe\Libs\Taxonomy;

use Tribe\Alert_Scoped\Tribe\Libs\Taxonomy\Walker\Walker_Flat_Category_Checklist;
/**
...
class Multi_Select_Taxonomy_Meta_Box
{
    ...
    public function callback($post, $box)
    {
        ...
        ?>" class="categorychecklist form-no-clear">
					<?php 
        \wp_terms_checklist($post->ID, ['taxonomy' => $this->taxonomy, 'walker' => new Walker_Flat_Category_Checklist()]);
        ?>
				</ul>
			</div>
		</div>

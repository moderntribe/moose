...
namespace Tribe\Alert_Scoped\Tribe\Libs\Nav;
...
abstract class Object_Nav_Walker extends Walker
{
    ...
    public function start_el(&$output, $data_object, $depth = 0, $args = null, $current_object_id = 0)
    {
        ...
        if (isset($item->post_type) && $item->post_type == 'nav_menu_item') {
            // only get classes if we're looking at a nav menu item
            $classes = \get_post_meta($item->{$id_field}, '_menu_item_classes', \true);
        }

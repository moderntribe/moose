...
namespace Tribe\Alert_Scoped\Tribe\Libs\Post_Type;

use Tribe\Alert_Scoped\Tribe\Libs\Post_Type\Meta_Box_Handlers\Meta_Box_Handler_Interface;
abstract class Post_Type_Config
{
     ...
     */
    public abstract function get_args();
    /**

...
namespace Tribe\Alert_Scoped\Tribe\Libs\Schema;
...
class Capabilities
{
    private $caps = ['editor' => ['read', 'read_private_posts', 'create_posts', 'edit_posts', 'edit_others_posts', 'edit_private_posts', 'edit_published_posts', 'delete_posts', 'delete_others_posts', 'delete_private_posts', 'delete_published_posts', 'publish_posts'], 'author' => ['read', 'create_posts', 'edit_posts', 'edit_published_posts', 'delete_posts', 'delete_published_posts', 'publish_posts'], 'contributor' => ['read', 'create_posts', 'edit_posts', 'delete_posts'], 'subscriber' => ['read']];
    /**

 ...
 */
namespace Tribe\Alert_Scoped\Whoops;

use InvalidArgumentException;
use Throwable;
use Tribe\Alert_Scoped\Whoops\Exception\ErrorException;
use Tribe\Alert_Scoped\Whoops\Handler\CallbackHandler;
use Tribe\Alert_Scoped\Whoops\Handler\Handler;
use Tribe\Alert_Scoped\Whoops\Handler\HandlerInterface;
use Tribe\Alert_Scoped\Whoops\Inspector\CallableInspectorFactory;
use Tribe\Alert_Scoped\Whoops\Inspector\InspectorFactory;
use Tribe\Alert_Scoped\Whoops\Inspector\InspectorFactoryInterface;
use Tribe\Alert_Scoped\Whoops\Inspector\InspectorInterface;
use Tribe\Alert_Scoped\Whoops\Util\Misc;
use Tribe\Alert_Scoped\Whoops\Util\SystemFacade;
final class Run implements RunInterface
{
     ...
     * @var bool
     */
    private $allowQuit = \true;
    /**
     * @var bool
     */
    private $sendOutput = \true;
    /**
     * @var integer|false
     */
     ...
     * @var bool
     */
    private $canThrowExceptions = \true;
    /**
    ...
    public function register()
    {
        if (!$this->isRegistered) {
            ...
            \class_exists("Tribe\\Alert_Scoped\\Whoops\\Exception\\ErrorException");
            \class_exists("Tribe\\Alert_Scoped\\Whoops\\Exception\\FrameCollection");
            \class_exists("Tribe\\Alert_Scoped\\Whoops\\Exception\\Frame");
            \class_exists("Tribe\\Alert_Scoped\\Whoops\\Exception\\Inspector");
            \class_exists("Tribe\\Alert_Scoped\\Whoops\\Inspector\\InspectorFactory");
    ...
    private function resolveHandler($handler)
    {
        ...
        if (!$handler instanceof HandlerInterface) {
            throw new InvalidArgumentException("Handler must be a callable, or instance of " . "Whoops\\Handler\\HandlerInterface");
        }
        return $handler;
    }
    /**

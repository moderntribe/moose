...
class PlainTextHandler extends Handler
{
     ...
     * @var bool
     */
    private $addPreviousToOutput = \true;
    /**
     * @var bool
     */
    ...
    {
        return \sprintf("%s: %s in file %s on line %d", \get_class($exception), $exception->getMessage(), $exception->getFile(), $exception->getLine());
    }
    /**
     * @return int
     */

...
use Tribe\Alert_Scoped\Symfony\Component\VarDumper\Cloner\AbstractCloner;
use Tribe\Alert_Scoped\Symfony\Component\VarDumper\Cloner\VarCloner;
use UnexpectedValueException;
use Tribe\Alert_Scoped\Whoops\Exception\Formatter;
use Tribe\Alert_Scoped\Whoops\Util\Misc;
use Tribe\Alert_Scoped\Whoops\Util\TemplateHelper;
class PrettyPageHandler extends Handler
{
     ...
     * @var array
     */
    protected $editors = ["sublime" => "subl://open?url=file://%file&line=%line", "textmate" => "txmt://open?url=file://%file&line=%line", "emacs" => "emacs://open?url=file://%file&line=%line", "macvim" => "mvim://open/?url=file://%file&line=%line", "phpstorm" => "phpstorm://open?file=%file&line=%line", "idea" => "idea://open?file=%file&line=%line", "vscode" => "vscode://file/%file:%line", "atom" => "atom://core/open/file?filename=%file&line=%line", "espresso" => "x-espresso://open?filepath=%file&lines=%line", "netbeans" => "netbeans://open/?f=%file:%line", "cursor" => "cursor://file/%file:%line"];
    /**
     * @var TemplateHelper
     */
    ...
    public function __construct()
    {
        ...
        if (\class_exists('Tribe\\Alert_Scoped\\Symfony\\Component\\VarDumper\\Cloner\\VarCloner')) {
    ...
    )
    {
        ...
        $this->extraTables[$label] = function (?\Tribe\Alert_Scoped\Whoops\Inspector\InspectorInterface $inspector = null) use($callback) {
            try {

 ...
 */
namespace Tribe\Alert_Scoped\Whoops\Util;

use Tribe\Alert_Scoped\Symfony\Component\VarDumper\Caster\Caster;
...
use Tribe\Alert_Scoped\Symfony\Component\VarDumper\Dumper\HtmlDumper;
use Tribe\Alert_Scoped\Whoops\Exception\Frame;
/**
...
class TemplateHelper
{
    ...
    {
        if (!$this->htmlDumper && \class_exists('Tribe\\Alert_Scoped\\Symfony\\Component\\VarDumper\\Cloner\\VarCloner')) {
    ...
    public function dump($value)
    {
        ...
        if ($dumper) {
            ...
            if (\class_exists('Tribe\\Alert_Scoped\\Symfony\\Component\\VarDumper\\Caster\\Caster')) {
        ...
        return \htmlspecialchars(\print_r($value, \true));
    }
    /**

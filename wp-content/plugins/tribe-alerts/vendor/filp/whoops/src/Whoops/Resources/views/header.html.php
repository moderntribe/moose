...
if (!empty($message)) {
    ...
    if (\count($previousMessages)) {
        ...
        <ul>
          <?php 
        foreach ($previousMessages as $i => $previousMessage) {
            ?>
            <li>
              <?php 
            echo $tpl->escape($previousMessage);
            ?>
              <span class="prev-exc-code">(<?php 
            echo $previousCodes[$i];
            ?>)</span>
            </li>
          <?php 
        }
...
?>
      <li>
        <a rel="noopener noreferrer" target="_blank" href="https://google.com/search?q=<?php 
...
?>" title="Search for help on Google.">
      ...
      <li>
        <a rel="noopener noreferrer" target="_blank" href="https://duckduckgo.com/?q=<?php 
echo \urlencode(\implode('\\', $name) . ' ' . $message);
?>" title="Search for help on DuckDuckGo.">
      ...
      <li>
        <a rel="noopener noreferrer" target="_blank" href="https://stackoverflow.com/search?q=<?php 
echo \urlencode(\implode('\\', $name) . ' ' . $message);
...
?></span>
    <button id="copy-button" class="rightButton clipboard" data-clipboard-text="<?php 
echo $tpl->escape($plain_exception);

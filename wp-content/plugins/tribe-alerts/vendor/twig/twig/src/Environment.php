...
use Tribe\Alert_Scoped\Twig\Cache\CacheInterface;
use Tribe\Alert_Scoped\Twig\Cache\FilesystemCache;
use Tribe\Alert_Scoped\Twig\Cache\NullCache;
use Tribe\Alert_Scoped\Twig\Cache\RemovableCacheInterface;
use Tribe\Alert_Scoped\Twig\Error\Error;
...
use Tribe\Alert_Scoped\Twig\Extension\CoreExtension;
use Tribe\Alert_Scoped\Twig\Extension\EscaperExtension;
use Tribe\Alert_Scoped\Twig\Extension\ExtensionInterface;
use Tribe\Alert_Scoped\Twig\Extension\OptimizerExtension;
use Tribe\Alert_Scoped\Twig\Extension\YieldNotReadyExtension;
use Tribe\Alert_Scoped\Twig\Loader\ArrayLoader;
use Tribe\Alert_Scoped\Twig\Loader\ChainLoader;
use Tribe\Alert_Scoped\Twig\Loader\LoaderInterface;
...
use Tribe\Alert_Scoped\Twig\Runtime\EscaperRuntime;
use Tribe\Alert_Scoped\Twig\RuntimeLoader\FactoryRuntimeLoader;
use Tribe\Alert_Scoped\Twig\RuntimeLoader\RuntimeLoaderInterface;
...
class Environment
{
    ...
    public function resolveTemplate($names) : TemplateWrapper
    {
        ...
        foreach ($names as $name) {
            if ($name instanceof Template) {
                \trigger_deprecation('twig/twig', '3.9', 'Passing a "%s" instance to "%s" is deprecated.', Template::class, __METHOD__);
    ...
    {
        \trigger_deprecation('twig/twig', '3.14', 'The "%s" method is deprecated.', __METHOD__);

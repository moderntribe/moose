...
use Tribe\Alert_Scoped\Twig\DeprecatedCallableInfo;
use Tribe\Alert_Scoped\Twig\Environment;
use Tribe\Alert_Scoped\Twig\Error\LoaderError;
use Tribe\Alert_Scoped\Twig\Error\RuntimeError;
use Tribe\Alert_Scoped\Twig\Error\SyntaxError;
use Tribe\Alert_Scoped\Twig\ExpressionParser\Infix\ArrowExpressionParser;
use Tribe\Alert_Scoped\Twig\ExpressionParser\Infix\AssignmentExpressionParser;
use Tribe\Alert_Scoped\Twig\ExpressionParser\Infix\BinaryOperatorExpressionParser;
use Tribe\Alert_Scoped\Twig\ExpressionParser\Infix\ConditionalTernaryExpressionParser;
use Tribe\Alert_Scoped\Twig\ExpressionParser\Infix\DotExpressionParser;
use Tribe\Alert_Scoped\Twig\ExpressionParser\Infix\FilterExpressionParser;
use Tribe\Alert_Scoped\Twig\ExpressionParser\Infix\FunctionExpressionParser;
use Tribe\Alert_Scoped\Twig\ExpressionParser\Infix\IsExpressionParser;
use Tribe\Alert_Scoped\Twig\ExpressionParser\Infix\IsNotExpressionParser;
use Tribe\Alert_Scoped\Twig\ExpressionParser\Infix\SquareBracketExpressionParser;
...
use Tribe\Alert_Scoped\Twig\ExpressionParser\Prefix\GroupingExpressionParser;
use Tribe\Alert_Scoped\Twig\ExpressionParser\Prefix\LiteralExpressionParser;
use Tribe\Alert_Scoped\Twig\ExpressionParser\Prefix\UnaryOperatorExpressionParser;
use Tribe\Alert_Scoped\Twig\Markup;
use Tribe\Alert_Scoped\Twig\Node\Expression\AbstractExpression;
use Tribe\Alert_Scoped\Twig\Node\Expression\Binary\AddBinary;
use Tribe\Alert_Scoped\Twig\Node\Expression\Binary\AndBinary;
use Tribe\Alert_Scoped\Twig\Node\Expression\Binary\BitwiseAndBinary;
use Tribe\Alert_Scoped\Twig\Node\Expression\Binary\BitwiseOrBinary;
use Tribe\Alert_Scoped\Twig\Node\Expression\Binary\BitwiseXorBinary;
use Tribe\Alert_Scoped\Twig\Node\Expression\Binary\ConcatBinary;
use Tribe\Alert_Scoped\Twig\Node\Expression\Binary\DivBinary;
use Tribe\Alert_Scoped\Twig\Node\Expression\Binary\ElvisBinary;
use Tribe\Alert_Scoped\Twig\Node\Expression\Binary\EndsWithBinary;
use Tribe\Alert_Scoped\Twig\Node\Expression\Binary\EqualBinary;
use Tribe\Alert_Scoped\Twig\Node\Expression\Binary\FloorDivBinary;
use Tribe\Alert_Scoped\Twig\Node\Expression\Binary\GreaterBinary;
use Tribe\Alert_Scoped\Twig\Node\Expression\Binary\GreaterEqualBinary;
use Tribe\Alert_Scoped\Twig\Node\Expression\Binary\HasEveryBinary;
use Tribe\Alert_Scoped\Twig\Node\Expression\Binary\HasSomeBinary;
use Tribe\Alert_Scoped\Twig\Node\Expression\Binary\InBinary;
use Tribe\Alert_Scoped\Twig\Node\Expression\Binary\LessBinary;
use Tribe\Alert_Scoped\Twig\Node\Expression\Binary\LessEqualBinary;
use Tribe\Alert_Scoped\Twig\Node\Expression\Binary\MatchesBinary;
use Tribe\Alert_Scoped\Twig\Node\Expression\Binary\ModBinary;
use Tribe\Alert_Scoped\Twig\Node\Expression\Binary\MulBinary;
use Tribe\Alert_Scoped\Twig\Node\Expression\Binary\NotEqualBinary;
use Tribe\Alert_Scoped\Twig\Node\Expression\Binary\NotInBinary;
use Tribe\Alert_Scoped\Twig\Node\Expression\Binary\NotSameAsBinary;
use Tribe\Alert_Scoped\Twig\Node\Expression\Binary\NullCoalesceBinary;
use Tribe\Alert_Scoped\Twig\Node\Expression\Binary\OrBinary;
use Tribe\Alert_Scoped\Twig\Node\Expression\Binary\PowerBinary;
use Tribe\Alert_Scoped\Twig\Node\Expression\Binary\RangeBinary;
use Tribe\Alert_Scoped\Twig\Node\Expression\Binary\SameAsBinary;
use Tribe\Alert_Scoped\Twig\Node\Expression\Binary\SpaceshipBinary;
use Tribe\Alert_Scoped\Twig\Node\Expression\Binary\StartsWithBinary;
use Tribe\Alert_Scoped\Twig\Node\Expression\Binary\SubBinary;
use Tribe\Alert_Scoped\Twig\Node\Expression\Binary\XorBinary;
use Tribe\Alert_Scoped\Twig\Node\Expression\BlockReferenceExpression;
use Tribe\Alert_Scoped\Twig\Node\Expression\Filter\DefaultFilter;
use Tribe\Alert_Scoped\Twig\Node\Expression\FunctionNode\EnumCasesFunction;
use Tribe\Alert_Scoped\Twig\Node\Expression\FunctionNode\EnumFunction;
use Tribe\Alert_Scoped\Twig\Node\Expression\GetAttrExpression;
use Tribe\Alert_Scoped\Twig\Node\Expression\ParentExpression;
use Tribe\Alert_Scoped\Twig\Node\Expression\Test\ConstantTest;
use Tribe\Alert_Scoped\Twig\Node\Expression\Test\DefinedTest;
use Tribe\Alert_Scoped\Twig\Node\Expression\Test\DivisiblebyTest;
use Tribe\Alert_Scoped\Twig\Node\Expression\Test\EvenTest;
use Tribe\Alert_Scoped\Twig\Node\Expression\Test\NullTest;
use Tribe\Alert_Scoped\Twig\Node\Expression\Test\OddTest;
use Tribe\Alert_Scoped\Twig\Node\Expression\Test\SameasTest;
use Tribe\Alert_Scoped\Twig\Node\Expression\Test\TrueTest;
use Tribe\Alert_Scoped\Twig\Node\Expression\Unary\NegUnary;
use Tribe\Alert_Scoped\Twig\Node\Expression\Unary\NotUnary;
use Tribe\Alert_Scoped\Twig\Node\Expression\Unary\PosUnary;
use Tribe\Alert_Scoped\Twig\Node\Expression\Unary\SpreadUnary;
use Tribe\Alert_Scoped\Twig\Node\Node;
use Tribe\Alert_Scoped\Twig\NodeVisitor\CorrectnessNodeVisitor;
use Tribe\Alert_Scoped\Twig\Parser;
use Tribe\Alert_Scoped\Twig\Sandbox\SecurityNotAllowedMethodError;
use Tribe\Alert_Scoped\Twig\Sandbox\SecurityNotAllowedPropertyError;
use Tribe\Alert_Scoped\Twig\Source;
use Tribe\Alert_Scoped\Twig\Template;
use Tribe\Alert_Scoped\Twig\TemplateWrapper;
use Tribe\Alert_Scoped\Twig\TokenParser\ApplyTokenParser;
use Tribe\Alert_Scoped\Twig\TokenParser\BlockTokenParser;
use Tribe\Alert_Scoped\Twig\TokenParser\DeprecatedTokenParser;
use Tribe\Alert_Scoped\Twig\TokenParser\DoTokenParser;
use Tribe\Alert_Scoped\Twig\TokenParser\EmbedTokenParser;
use Tribe\Alert_Scoped\Twig\TokenParser\ExtendsTokenParser;
use Tribe\Alert_Scoped\Twig\TokenParser\FlushTokenParser;
use Tribe\Alert_Scoped\Twig\TokenParser\ForTokenParser;
use Tribe\Alert_Scoped\Twig\TokenParser\FromTokenParser;
use Tribe\Alert_Scoped\Twig\TokenParser\GuardTokenParser;
use Tribe\Alert_Scoped\Twig\TokenParser\IfTokenParser;
use Tribe\Alert_Scoped\Twig\TokenParser\ImportTokenParser;
use Tribe\Alert_Scoped\Twig\TokenParser\IncludeTokenParser;
use Tribe\Alert_Scoped\Twig\TokenParser\MacroTokenParser;
use Tribe\Alert_Scoped\Twig\TokenParser\SetTokenParser;
use Tribe\Alert_Scoped\Twig\TokenParser\TypesTokenParser;
use Tribe\Alert_Scoped\Twig\TokenParser\UseTokenParser;
use Tribe\Alert_Scoped\Twig\TokenParser\WithTokenParser;
use Tribe\Alert_Scoped\Twig\TwigFilter;
use Tribe\Alert_Scoped\Twig\TwigFunction;
use Tribe\Alert_Scoped\Twig\TwigTest;
use Tribe\Alert_Scoped\Twig\Util\CallableArgumentsExtractor;
final class CoreExtension extends AbstractExtension
{
    ...
    public function getFilters() : array
    {
        return [
            ...
            new TwigFilter('sort', [self::class, 'sort'], ['needs_environment' => \true, 'needs_is_sandboxed' => \true]),
            new TwigFilter('merge', [self::class, 'merge']),
            new TwigFilter('batch', [self::class, 'batch']),
            new TwigFilter('column', [self::class, 'column'], ['needs_environment' => \true, 'needs_is_sandboxed' => \true]),
            new TwigFilter('filter', [self::class, 'filter'], ['needs_environment' => \true, 'needs_is_sandboxed' => \true]),
            new TwigFilter('map', [self::class, 'map'], ['needs_environment' => \true, 'needs_is_sandboxed' => \true]),
            new TwigFilter('reduce', [self::class, 'reduce'], ['needs_environment' => \true, 'needs_is_sandboxed' => \true]),
            new TwigFilter('find', [self::class, 'find'], ['needs_environment' => \true, 'needs_is_sandboxed' => \true]),
    ...
    {
        return [new TwigTest('even', null, ['node_class' => EvenTest::class, 'always_allowed_in_sandbox' => \true]), new TwigTest('odd', null, ['node_class' => OddTest::class, 'always_allowed_in_sandbox' => \true]), new TwigTest('defined', null, ['node_class' => DefinedTest::class, 'always_allowed_in_sandbox' => \true]), new TwigTest('same as', null, ['node_class' => SameasTest::class, 'one_mandatory_argument' => \true, 'always_allowed_in_sandbox' => \true]), new TwigTest('none', null, ['node_class' => NullTest::class, 'always_allowed_in_sandbox' => \true]), new TwigTest('null', null, ['node_class' => NullTest::class, 'always_allowed_in_sandbox' => \true]), new TwigTest('divisible by', null, ['node_class' => DivisiblebyTest::class, 'one_mandatory_argument' => \true, 'always_allowed_in_sandbox' => \true]), new TwigTest('constant', null, ['node_class' => ConstantTest::class]), new TwigTest('empty', [self::class, 'testEmpty'], ['always_allowed_in_sandbox' => \true]), new TwigTest('iterable', 'is_iterable', ['always_allowed_in_sandbox' => \true]), new TwigTest('sequence', [self::class, 'testSequence'], ['always_allowed_in_sandbox' => \true]), new TwigTest('mapping', [self::class, 'testMapping'], ['always_allowed_in_sandbox' => \true]), new TwigTest('true', null, ['node_class' => TrueTest::class, 'always_allowed_in_sandbox' => \true])];
    }
    public function getNodeVisitors() : array
    {
        return [new CorrectnessNodeVisitor()];
    }
    ...
    public static function cycle($values, $position) : mixed
    {
        if (!\is_array($values)) {
            ...
            if (!\is_countable($values)) {
                ...
                \trigger_deprecation('twig/twig', '3.12', 'Passing a non-countable sequence of values to "%s()" is deprecated.', __METHOD__);
     ...
     * @internal
     */
    public static function include(Environment $env, $context, $template, $variables = [], $withContext = \true, $ignoreMissing = \false, $sandboxed = \false)
    {
    ...
    public static function checkArrow(bool $isSandboxed, $arrow, $thing, $type)
    {
        ...
        \trigger_deprecation('twig/twig', '3.15', 'Passing a callable that is not a PHP \\Closure as an argument to the "%s" %s is deprecated.', $thing, $type);
    }
    /**

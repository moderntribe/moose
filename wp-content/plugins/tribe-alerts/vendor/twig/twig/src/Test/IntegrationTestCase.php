...
use Tribe\Alert_Scoped\PHPUnit\Framework\Attributes\Group;
...
abstract class IntegrationTestCase extends TestCase
{
     ...
     * @return void
     */
    #[\PHPUnit\Framework\Attributes\DataProvider('provideLegacyTests'), \PHPUnit\Framework\Attributes\Group('legacy')]
    ...
    public function getTests($name, $legacyTests = \false)
    {
        try {
            ...
            \trigger_deprecation('twig/twig', '3.13', 'Not overriding "%s::getFixturesDirectory()" in "%s" is deprecated. This method will be abstract in 4.0.', self::class, static::class);
    ...
    protected function doIntegrationTest($file, $message, $condition, $templateSources, $exception, $outputs, $deprecation = '')
    {
        ...
        foreach ($outputs as $i => $match) {
            ...
            if (\false !== $exception) {
                ...
                $constraintClass = \class_exists('Tribe\\Alert_Scoped\\PHPUnit\\Framework\\Constraint\\Exception') ? 'PHPUnit\\Framework\\Constraint\\Exception' : 'PHPUnit_Framework_Constraint_Exception';

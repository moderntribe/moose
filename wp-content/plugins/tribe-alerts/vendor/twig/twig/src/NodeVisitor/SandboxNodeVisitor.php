...
use Tribe\Alert_Scoped\Twig\Node\CheckSecurityCallNode;
use Tribe\Alert_Scoped\Twig\Node\CheckSecurityNode;
use Tribe\Alert_Scoped\Twig\Node\CheckToStringNode;
...
use Tribe\Alert_Scoped\Twig\Node\Expression\FunctionExpression;
...
use Tribe\Alert_Scoped\Twig\Util\CallableParameters;
/**
...
final class SandboxNodeVisitor implements NodeVisitorInterface
{
    ...
    private static function isAlwaysAllowedInSandbox($subject) : bool
    {
        ...
        \trigger_deprecation('twig/twig', '3.28', 'Not implementing the "isAlwaysAllowedInSandbox()" method in "%s" is deprecated. This method will be part of the "%s" interface in 4.0.', $subject::class, $interface);
        return \false;
    }

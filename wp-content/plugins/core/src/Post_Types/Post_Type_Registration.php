...
class Post_Type_Registration {
	 ...
	 * @param \Tribe\Plugin\Post_Types\Meta_Box_Handlers\Meta_Box_Handler_Interface $meta_box_handler
	 */
	public static function register( Post_Type_Config $config, ?Meta_Box_Handler_Interface $meta_box_handler = null ): void {
	 ...
	 * @param \Tribe\Plugin\Post_Types\Meta_Box_Handlers\Meta_Box_Handler_Interface $meta_box_handler
	 */
	private static function build_registration_callback( Post_Type_Config $config, ?Meta_Box_Handler_Interface $meta_box_handler = null ): \Closure {
		return static function () use ( $config, $meta_box_handler ): void {

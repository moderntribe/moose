	...
	public function get_fields(): array {
		return [
			Image::make( esc_html__( 'Login Logo', 'tribe' ), self::LOGIN_LOGO )
				->instructions( 'An SVG image file is the recommended file type for this image. If a PNG or JPG image is used the recommended dimensions are 900px by 200px.' )
				->returnFormat( 'id' )

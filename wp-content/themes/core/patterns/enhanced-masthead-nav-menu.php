...
/**
* Title: Enhanced Masthead Navigation Menu
...
*/
?>
<!-- wp:group {"metadata":{"categories":["navigation","menu"],"patternName":"patterns/enhanced-masthead-nav-menu","name":"Enhanced Masthead Navigation Menu"},"align":"wide","className":"nav-menu__enhanced alignwide","style":{"spacing":{"blockGap":"var:preset|spacing|40","padding":{"right":"0","left":"0"}}},"layout":{"type":"default"}} -->
...
<div class="wp-block-button is-style-ghost tribe-button-has-icon"><a class="wp-block-button__link wp-element-button" href="#">some button</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group -->

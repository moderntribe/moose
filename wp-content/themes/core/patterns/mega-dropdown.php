...
*/
?>
<!-- wp:group {"metadata":{"categories":["navigation","menu"],"patternName":"patterns/mega-dropdown","name":"Mega Dropdown"},"align":"wide","className":"nav-menu__enhanced alignwide","style":{"spacing":{"blockGap":"var:preset|spacing|40","padding":{"right":"0","left":"0"}}},"layout":{"type":"default"}} -->
<div class="wp-block-group nav-menu__enhanced alignwide" style="padding-right:0;padding-left:0"><!-- wp:group {"metadata":{"name":"Mega Dropdown Card"},"style":{"spacing":{"blockGap":"var:preset|spacing|30"},"layout":{"selfStretch":"fixed","flexSize":"400px"}},"layout":{"type":"flex","orientation":"vertical"}} -->
...
<div class="wp-block-column tribe-has-stacking-order" style="flex-basis:25%;--tribe-stacking-order:0"><!-- wp:paragraph {"className":"is-style-default","style":{"spacing":{"margin":{"top":"0","bottom":"0"}}}} -->
...
<div class="wp-block-column tribe-has-stacking-order" style="flex-basis:25%;--tribe-stacking-order:0"><!-- wp:paragraph {"style":{"spacing":{"margin":{"top":"0","bottom":"0"}}}} -->
